...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene)
{
	...
	// 4. height maps
	std::vector<TextureId> heightMaps = loadMaterialTextures(material, aiTextureType_AMBIENT, "texture_height");
...
vector<TextureId> Model::loadMaterialTextures(aiMaterial* mat, aiTextureType type, string typeName)
{
	vector<TextureId> textures;
